...
def get_nn_model(input_size):
    ...
    model.add(Dense(units=input_size, activation="relu",kernel_initializer="lecun_normal"))
    #model.add(Dense(units=500, activation="relu",kernel_initializer="lecun_normal")) 
    #model.add(Dropout(0.2, input_shape=(1000,)))
    model.add(Dense(units=input_size/2, activation='relu',kernel_initializer="lecun_normal"))
    model.add(Dropout(0.2, input_shape=(input_size/2,)))
